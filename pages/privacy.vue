<template>
  <div class="bg-white px-6 py-32 lg:px-8">
    <div class="mx-auto max-w-3xl text-base leading-7 text-gray-700">
      ...
      <p class="mt-4">
        PCL-Labs Privacy Policy.
        Last updated: May 3, 2024
      </p>
      <p class="mt-4">
        This Privacy Policy describes how PCL-Labs (the "Site", "we", "us", or "our") collects, uses, and discloses your personal information when you visit, use our services, or make a purchase from paulchrisluke.com (the "Site") or otherwise communicate with us (collectively, the "Services"). For purposes of this Privacy Policy, "you" and "your" means you as the user of the Services, whether you are a customer, website visitor, or another individual whose information we have collected pursuant to this Privacy Policy.
      </p>
      <p class="mt-4">
        Please read this Privacy Policy carefully. By using and accessing any of the Services, you agree to the collection, use, and disclosure of your information as described in this Privacy Policy. If you do not agree to this Privacy Policy, please do not use or access any of the Services.
      </p>
      <h2 class="mt-6 text-xl leading-8">Changes to This Privacy Policy</h2>
      <p class="mt-4">
        We may update this Privacy Policy from time to time, including to reflect changes to our practices or for other operational, legal, or regulatory reasons. We will post the revised Privacy Policy on the Site, update the "Last updated" date and take any other steps required by applicable law.
      </p>
      <h2 class="mt-6 text-xl leading-8">How We Collect and Use Your Personal Information</h2>
      <p class="mt-4">
      ...
      <h3 class="mt-6 text-xl leading-8">What Personal Information We Collect</h3>
      <p class="mt-4">
        The types of personal information we obtain about you depends on how you interact with our Site and use our Services. When we use the term "personal information", we are referring to information that identifies, relates to, describes or can be associated with you. The following sections describe the categories and specific types of personal information we collect.
      </p>
      <h4 class="mt-6 text-xl leading-8">Information We Collect Directly from You</h4>
      <p class="mt-4">
      ...
      <h4 class="mt-6 text-xl leading-8">Information We Collect through Cookies</h4>
      <p class="mt-4">
      ...
      <h2 class="mt-6 text-xl leading-8">How We Use Your Personal Information</h2>
      <p class="mt-4">
      ...
      <h2 class="mt-6 text-xl leading-8">How We Disclose Personal Information</h2>
      <p class="mt-4">
      ...
      <h2 class="mt-6 text-xl leading-8">User Generated Content</h2>
      <p class="mt-4">
      ...
      <h2 class="mt-6 text-xl leading-8">Third Party Websites and Links</h2>
      <p class="mt-4">
      ...
      <h2 class="mt-6 text-xl leading-8">Children's Data</h2>
      <p class="mt-4">
      ...
      <h2 class="mt-6 text-xl leading-8">Security and Retention of Your Information</h2>
      <p class="mt-4">
      ...
      <h2 class="mt-6 text-xl leading-8">Your Rights and Choices</h2>
      <p class="mt-4">
      ...
      <h2 class="mt-6 text-xl leading-8">Complaints</h2>
      <p class="mt-4">
        If you have complaints about how we process your personal information, please contact us using the contact details provided below. If you are not satisfied with our response to your complaint, depending on where you live you may have the right to appeal our decision by contacting us using the contact details set out below, or lodge your complaint with your local data protection authority.
      </p>
      <h2 class="mt-6 text-xl leading-8">International Users</h2>
      <p class="mt-4">
      ...
      <h2 class="mt-6 text-xl leading-8">Contact</h2>
      <p class="mt-4">
