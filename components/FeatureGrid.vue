...
// Dummy data for the features, using Heroicons
const features = ref([
  {
    name: 'Reliable Performance',
    description: 'Ensure consistent and dependable performance that meets your operational needs.',
    icon: ChevronDownIcon
  },
  {
    name: 'Easy Integration',
    description: 'Integrates smoothly with your existing applications and workflows.',
    icon: EnvelopeIcon
  }
]);
</script>
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl lg:text-center">
        <h2 class="text-lg font-semibold leading-8 tracking-tight text-indigo-600">
          MY FEATURE TITLE HERE
        </h2>
        <p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
          MY FEATURE SUBTITLE HERE
        </p>
