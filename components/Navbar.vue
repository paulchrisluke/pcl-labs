<template>
  <Disclosure as="nav" class="bg-gray-900" v-slot="{ open }">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-90">
  ...
  <a href="#" class="inline-flex items-center text-gray-300 rounded-md px-3 py-2 text-sm font-medium hover:text-white hover:bg-gray-700">
    Industries
    ...
    <DisclosurePanel class="md:hidden z-100">
